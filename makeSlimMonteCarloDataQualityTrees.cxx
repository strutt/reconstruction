...
/***********************************************************************************************************
 ...
 Description:
             Reconstruct Monte Carlo data set.
********************************************************************************************************* */
...
int main(int argc, char *argv[]){
  ...
  for(Int_t run=firstRun; run<=lastRun; run++){
    ...
    TString fileName = TString::Format("~/UCL/ANITA/monteCarlo/%s/run%d/SimulatedAnitaHeadFile%d.root", mcDir.Data(), run, run);
    headChain->Add(fileName);

    fileName = TString::Format("~/UCL/ANITA/monteCarlo/%s/run%d/SimulatedAnitaEventFile%d.root", mcDir.Data(), run, run);
